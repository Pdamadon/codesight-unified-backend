...
exports.runQualityReportingTests = runQualityReportingTests;
const data_validation_1 = require("./services/data-validation");
const quality_threshold_1 = require("./services/quality-threshold");
const quality_reporting_1 = require("./services/quality-reporting");
// Mock session data for testing
const generateMockSessions = (count, baseDate = new Date()) => {
    const sessions = [];
...
async function runQualityReportingTests() {
        ...
        unifiedSession: {
            findMany: async ({ where, include, orderBy }) => {
                ...
                if (where.qualityScore) {
                    filteredSessions = filteredSessions.filter(s => s.qualityScore >= (where.qualityScore.gte || 0) &&
    ...
    const reportingService = new quality_reporting_1.QualityReportingService(mockPrisma, thresholdService, validationService);
