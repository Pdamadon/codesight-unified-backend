...
async function testNavigationStrategy() {
  ...
  const navigationService = new NavigationStrategyService(prisma, openaiService);
...
function generateInteractionsForPattern(sessionId: string, pattern: string): any[] {
